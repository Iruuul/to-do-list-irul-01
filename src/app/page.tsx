  ...
  return (
    <main className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-6 py-12">
      ...
      <p className="text-gray-400 text-center max-w-md mb-12">
        Saya adalah seorang mahasiswa Informatika yang tertarik dalam pengembangan web dan desain antarmuka pengguna.</p>
      ...
      <p className="text-gray-400 mb-4">Mari kita bangun sesuatu bersama!</p>
      <a
